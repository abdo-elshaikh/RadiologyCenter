        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoveragePercent = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyDetails = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CoveragePercent = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    TransferType = table.Column<int>(type: "int", maxLength: 100, nullable: false),
                    Attachment = table.Column<int>(type: "int", maxLength: 255, nullable: false),
                    TreatingDoctor = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_TechnicalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientContracts_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExamId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExamNameEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ExamNameAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Examinations_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentExamination", x => new { x.AppointmentId, x.ExaminationId });
                    table.ForeignKey(
                        name: "FK_AppointmentExamination_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentExamination_Examinations_ExaminationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentExamination_ExaminationId",
                table: "AppointmentExamination",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Examinations_UnitId",
                table: "Examinations",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientContracts_ContractId",
